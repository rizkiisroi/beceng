...
import com.beceng.carapp.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.beceng.carapp.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "carappEmployee";
